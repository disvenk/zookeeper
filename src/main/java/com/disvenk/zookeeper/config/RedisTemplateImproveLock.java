 ...
 */
@Component
public class RedisTemplateImproveLock {

    private static Logger logger = LoggerFactory.getLogger(RedisTemplateImproveLock.class);
     ...
     * 锁标志对应的key
     */
    private String lockKey="order_lock";
    ...
    public RedisTemplateImproveLock(){
    }
     ...
     */
    public RedisTemplateImproveLock(StringRedisTemplate redisTemplate, String lockKey) {
     ...
     */
    public RedisTemplateImproveLock(StringRedisTemplate redisTemplate, String lockKey, int expireTime) {
     ...
     */
    public RedisTemplateImproveLock(StringRedisTemplate redisTemplate, String lockKey, long timeOut) {
        this(redisTemplate, lockKey);
     ...
     * @param timeOut       请求锁的超时时间(单位：毫秒)
     */
    public RedisTemplateImproveLock(StringRedisTemplate redisTemplate, String lockKey, int expireTime, long timeOut) {
